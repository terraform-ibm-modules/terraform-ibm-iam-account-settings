...
| <a name="input_enable_global_cloud_shell_settings"></a> [enable\_global\_cloud\_shell\_settings](#input\_enable\_global\_cloud\_shell\_settings) | Enable/Disable Global Cloud Shell settings in the account. | `bool` | `false` | no |
