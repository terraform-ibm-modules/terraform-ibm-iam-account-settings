...
| <a name="input_skip_cloud_shell_calls"></a> [skip\_cloud\_shell\_calls](#input\_skip\_cloud\_shell\_calls) | Enable/Disable Global Cloud Shell settings in the account. | `bool` | `false` | no |
