...
| <a name="input_ibm_approved_ip_addresses"></a> [ibm\_approved\_ip\_addresses](#input\_ibm\_approved\_ip\_addresses) | Base set of IBM approved IPs, which are documented and sourced from https://pages.github.ibm.com/ibmcloud/Security/guidance/network-access-guidelines.html#pre-approved-ips and https://cloud.ibm.com/docs/schematics?topic=schematics-allowed-ipaddresses | `list(any)` | `[]` | no |
