...
| <a name="input_private_endpoint"></a> [private\_endpoint](#input\_private\_endpoint) | To enable/disable the private endpoint in the account public access. | `bool` | `true` | no |
